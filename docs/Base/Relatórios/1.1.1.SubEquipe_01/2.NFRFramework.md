...
Para esta etapa do projeto, a **SubEquipe 01** selecionou o atributo de
...
O recorte escolhido pela SubEquipe 01 para a elaboração dos artefatos foi o
...
SubEquipe 01** a partir da análise do fluxo de Login representado no Rich
...
O softgoal principal do SIG desenvolvido pela SubEquipe 01 é:
...
<font size="2">
<p style="text-align: center">
Fonte: Integrantes da SubEquipe 01 (2026).
</p>
</font>
...
**Autor:** Arthur Fernandes, Giovana Fontes e João (2026).
...
A estrutura conceitual consolidada do SIG desenvolvido pela SubEquipe 01 é
apresentada abaixo.
...
| 1.2 | 27/08/2026 | Organização e correção do documento | [Giovana Fontes](https://github.com/GiovanaFontesS) | [Giovana Fontes](https://github.com/GiovanaFontesS) | Correção da numeração das seções, organização das relações do NFR Framework, revisão das operacionalizações, consolidação da estrutura do SIG e ajustes de formatação em Markdown. |
...
| 1.4 | 27/08/2026 | Ajuste na imagem quebrada | [Arthur Fernandes](https://github.com/arthurfernandesj) | c | Ajuste na imagem do SIG de Usabilidade ajustada, estava quebrada. |
