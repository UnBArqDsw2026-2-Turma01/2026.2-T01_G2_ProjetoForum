...
O Mapa Mental serve como um dos insumos para os demais artefatos produzidos
pela subequipe.

| Artefato | Relação |
| -------- | ------- |
| NFR Framework | As preocupações relacionadas à interação e facilidade de uso identificadas no Mapa Mental contribuem para a definição do softgoal de Usabilidade. |
...
| :---: | :---: | :--- | :---: | :---: | :--- |
| 1.0 | 27/08/2026 | Criação da página dos Atefatos Generalista | [Pedro Ramos](https://github.com/PedroRSR) |  [Arthur Fernandes](https://github.com/arthurfernandesj) | Documento criado direcionado aos artefatos escolhidos pela SubEquipe para a tela inicial do TabNews. |