...
| :---: | :---: | :--- | :---: | :---: | :--- |
| 1.0 | 26/08/2026 | Criação do diagrama BPMN | [Pablo Rodrigues Lima](https://github.com/Pablo-R-L) | --- | Diagrama BPMN criado, referente ao fluxo do usuário na tela inicial, e adicionado ao repositorio de imagens. |
| 1.1 | 27/08/2026 | Criação da página BPMN.md | [Pablo Rodrigues Lima](https://github.com/Pablo-R-L) | --- | Criação do documento referente ao BPMN e adição dos diagramas à página. |
| 1.2 | 28/08/2026 | Adição do histórico | [Pablo Rodrigues Lima](https://github.com/Pablo-R-L) | --- | Adição do histórico de versões conforme as diretrizes da Entrega 1. |
