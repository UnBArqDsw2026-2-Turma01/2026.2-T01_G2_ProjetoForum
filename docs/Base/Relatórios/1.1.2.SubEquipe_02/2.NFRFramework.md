...
| ---------- | :----------------------------------------------------- | :---------------------------------- |
| 19/0088885 | [Isaac Menezes Pereira](https://github.com/pratamz250) | Elaboração e revisão do NFR Framework |
| 23/1029841 | [Pablo Rodrigues Lima](https://github.com/Pablo-R-L)   | Elaboração e revisão do NFR Framework |
| 22/2031680 | [Pedro Ramos Sousa Reis](https://github.com/PedroRSR)  | Elaboração e revisão do NFR Framework |
...
O sistema aprensenta seus elementos (campos, opções e labels) de maneira previsível e estruturada.
...
![SIG de Usabilidade, Conforto Ocular e Navegação](../../../assets/images/NFR_subGrupo2.png)
...
3. **TabNews**. Plataforma utilizada como referência para análise do domínio de fóruns e compartilhamento de conhecimento. Disponível em: <https://www.tabnews.com.br/>. Acesso em: 25/08/26
...
| :---: | :---: | :--- | :---: | :---: | :--- |
| 1.0 | 25/08/2026 | Reestruturação e adaptação do NFR Framework | [Isaac Menezes](https://github.com/pratamz250) | [Pedro Ramos Sousa Reis](https:/github.com/PedroRSR) | Documento atualizado para alinhar o texto com o SIG correspondente, contemplando Conforto Ocular, Usabilidade e Navegação. |
| 1.1 | 28/08/26 | Auxílio no NFR | [Pablo Rodrigues Lima](https://github.com/Pablo-R-L) | [Isaac Menezes](https://github.com/pratamz250) | Ajuste de redação e organização dos elementos do SIG para maior clareza. |
| 1.2 | 28/08/26 | Auxílio no NFR | [Pedro Ramos Sousa Reis](https:/github.com/PedroRSR) | [Isaac Menezes](https://github.com/pratamz250) | Ajuste final de revisão, correções de linguagem e alinhamento ao documento base. |
