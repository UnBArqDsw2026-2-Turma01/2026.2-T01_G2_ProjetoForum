...
| :---: | :---: | :--- | :---: | :---: | :--- |
| 1.0 | 27/08/2026 | Criação do documento de Artefato Generalista da Subequipe_03 | [Leonardo Bonetti](https://github.com/LeoFacB) |  [Caio Alexandre ](https://github.com/bitterteriyaki)| Estrutura inicial do documento, com justificativa da escolha e delimitação de escopo. |
