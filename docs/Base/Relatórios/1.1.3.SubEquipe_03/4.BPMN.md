...
| :----: | :--------: | :-------------------------------------- | :--------------------------------------------: | :-----------------------------------------------------: | :------------------------------------------------------------------------------------- |
|   1.0  | 26/08/2026 | Criação da página de BPMN | [Leonardo Bonetti](https://github.com/LeoFacB) | [Arthur Fernandes](https://github.com/arthurfernandesj) |  Revisão do conteúdo e verificação da coerência das informações apresentadas na página.|